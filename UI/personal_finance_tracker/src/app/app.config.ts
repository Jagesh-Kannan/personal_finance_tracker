...
import { LucideFileText, LucideFunnel, LucideFunnelPlus, LucideImport, LucidePlus, provideLucideIcons } from '@lucide/angular';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideLucideIcons(LucideFileText, LucideImport, LucidePlus, LucideFunnel, LucideFunnelPlus),
